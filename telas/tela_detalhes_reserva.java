...
public class tela_detalhes_reserva extends JDialog {
    ...
    public tela_detalhes_reserva(Frame owner, Reserva reserva, Color corPrincipal, Color corDestaque) {
        ...
        // --- ALTERAÇÃO: Cor padrão atualizada para #063D97 ---
        this.corPrincipal = (corPrincipal != null) ? corPrincipal : Color.decode("#063D97");
    ...
    /**
     * ALTERAÇÃO: Novo método para estilizar botão com borda colorida e texto
     * colorido.
     */
    private void estilizarBotaoBorda(JButton botao, Color cor) {
        botao.setBackground(Color.WHITE);
        botao.setForeground(cor); // Texto na cor especificada
        botao.setFont(new Font("Arial", Font.BOLD, 12));
        botao.setCursor(new Cursor(Cursor.HAND_CURSOR));
        botao.setFocusPainted(false);
        // Borda na cor especificada
        botao.setBorder(BorderFactory.createLineBorder(cor));
    }
    ...
    private JPanel criarSecaoAcoes() {
        ...
        if ("Confirmada".equals(reserva.getStatus())) {
            ...
            // ALTERAÇÃO: Botão secundário com borda laranja
            estilizarBotaoBorda(btnRemoverConfirmada, corDestaque);
            ...
            // ALTERAÇÃO: Botão secundário com borda azul
            estilizarBotaoBorda(btnComprovante, corPrincipal);
            ...
            // ALTERAÇÃO: Botão secundário com borda laranja
            estilizarBotaoBorda(btnRemoverPendente, corDestaque);
        ...
        // ALTERAÇÃO: Botão secundário com borda azul
        estilizarBotaoBorda(btnVoltar, corPrincipal);
    ...
    // --- MÉTODOS DE AÇÃO (sem alterações significativas) ---
