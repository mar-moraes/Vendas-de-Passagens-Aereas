...
public class TelaResultadosBusca extends JDialog {
    ...
    public TelaResultadosBusca(Frame owner, String origem, String destino, String dataBusca) {
        ...
        btnSelecionar.setUI(new BasicButtonUI());

        Color corBotaoSelecionar = Color.decode("#063D97");
        btnSelecionar.setBackground(corBotaoSelecionar);
        btnSelecionar.setForeground(Color.WHITE);
        btnSelecionar.setFont(new Font("Arial", Font.BOLD, 14));
        btnSelecionar.setBorder(BorderFactory.createLineBorder(corBotaoSelecionar));
        ...
        btnReservar.setUI(new BasicButtonUI());
        btnReservar.setFont(new Font("Arial", Font.BOLD, 14));
        btnReservar.setBackground(COR_DESTAQUE); // Changed to Orange
        btnReservar.setForeground(Color.WHITE);
        btnReservar.setBorder(BorderFactory.createLineBorder(COR_DESTAQUE));
        btnReservar.setFocusPainted(false);
        btnReservar.setPreferredSize(new Dimension(150, 40));
        ...
        btnVoltar.setBorder(BorderFactory.createLineBorder(COR_PRINCIPAL));
